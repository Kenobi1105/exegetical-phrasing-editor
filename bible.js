...
function bBuildAccordion(){
  ...
  function buildTestamentSection(label, books, abbrs, corpusKey){
    ...
    rows.forEach((rowBooks,rowIdx)=>{
      ...
      rowEl.className='bpg-grid';rowEl.style.paddingBottom='0';rowEl.style.marginBottom='6px';
...
async function s2ConfirmBible(){
  ...
  recomputeIds();
  // ch-t-lbl always reads "Translation" (set by _applySessionLabels); version shown in version-sub.
