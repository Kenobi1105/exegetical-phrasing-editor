...
const LANGS = {
  en: {
    ...
    'ann.span.hint':     'Click the first block, then a different block, to mark a span.',
    'ann.span.diff-block':'Please click a different block for the end of the span.',
    'ann.arc.add':       'Add arc connector',
    'ann.arc.hint':      'Ctrl+click a word in one block, then Ctrl+click a word in another block.',
    'ann.arc.diff-block':'Please click a word in a different block.',
  ...
  zh: {
    ...
    'ann.span.add':      '添加跨度标记',
    'ann.span.hint':     '点击第一个词块，再点击另一个词块，以标记跨度。',
    'ann.span.diff-block':'请点击不同的词块作为跨度终点。',
    'ann.arc.add':       '添加弧形连接',
    'ann.arc.hint':      'Ctrl+单击一个词块中的单词，再 Ctrl+单击另一个词块中的单词。',
    'ann.arc.diff-block':'请点击不同词块中的单词。',
